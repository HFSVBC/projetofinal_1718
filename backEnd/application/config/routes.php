...
// UTILIZADOR
$route['user/login']          = 'UserLoader/logIn'; // registers user if not already registered | {token => String, user_type => String}
$route['user/logout']         = 'UserLoader/logOut'; // logs user out
