with open('./dbscripts/create.sql', 'w') as infile:
    infile.write("PRAGMA foreign_keys = ON;")
    infile.write("CREATE TABLE Aluno (ID INTEGER PRIMARY KEY AUTOINCREMENT, NumAluno INTEGER NOT NULL, CONSTRAINT NumRest UNIQUE (NumAluno));\n")
    ...
    infile.write("CREATE TABLE Acessos (ID INTEGER PRIMARY KEY AUTOINCREMENT, IDSala INTEGER, NumAluno INTEGER, FOREIGN KEY(NumAluno) REFERENCES Aluno(NumAluno), FOREIGN KEY (IDSala) REFERENCES Sala(ID);")
