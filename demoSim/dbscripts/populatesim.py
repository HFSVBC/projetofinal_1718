...
with open('populate.sql', 'w') as infile:
    ...
    for i in range(1, 20):
        ...
        infile.write("INSERT INTO Turma(NInscritos, MaxInscritos, IDDisciplina, NumProf) VALUES(" + str(n_inscritos_turma) + "," + str(max_inscritos_turma) + "," + Tipo[r.randint(0, len(Tipo)-1)] + "," + str(Disciplinas[r.randint(0, len(Disciplinas)-1)]) + "," + str(r.randint(0,100)) + ");\n" )
